---- MODULE BrokenDoor_TTrace_1775088487 ----
...
\* to `JsonSerialize`. For example, a sub-sequence of _TETrace.
    \* ASSUME
    \*     LET J == INSTANCE Json
    \*         IN J!JsonSerialize("BrokenDoor_TTrace_1775088487.json", _TETrace)
...
\*
\*trace == IODeserialize("BrokenDoor_TTrace_1775088487.bin", TRUE)
\*
\*=============================================================================
\*
...
trace == 
    ...
    ([through |-> {},door |-> "unlocked",pc |-> [Alice |-> "walk", Bob |-> "walk"]]),
    ([through |-> {"Alice"},door |-> "locked",pc |-> [Alice |-> "Done", Bob |-> "walk"]]),
    ([through |-> {"Alice", "Bob"},door |-> "locked",pc |-> [Alice |-> "Done", Bob |-> "Done"]])
    >>
----
...
---- CONFIG BrokenDoor_TTrace_1775088487 ----
...
ALIAS
    _expression
=============================================================================
\* Generated on Wed Apr 01 17:08:07 PDT 2026