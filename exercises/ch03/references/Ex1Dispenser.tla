...
\* BEGIN TRANSLATION (chksum(pcal) = "d1e8c926" /\ chksum(tla) = "983684ee")
...
Check == /\ pc = "Check"
         /\ Assert(owed = 0, "Failure of assertion at line 33, column 5.")
         /\ Assert(pennies < 5, "Failure of assertion at line 34, column 5.")
         /\ Assert(nickels * 5 + pennies = target, 
