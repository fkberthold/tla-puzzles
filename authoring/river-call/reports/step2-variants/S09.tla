...
OpenTwo(o, p) ==
    /\ o # p
    /\ \A s \in Owners : Senior(s, o) => ~ calling[s]
    /\ \A s \in Owners : Senior(s, p) => ~ calling[s]
    /\ \E m \in (diverted[o] + 1) .. Decree[o] :
       \E n \in (diverted[p] + 1) .. Decree[p] :
           /\ Taken([diverted EXCEPT ![o] = m]) =< Flow
           /\ Taken([diverted EXCEPT ![p] = n]) =< Flow
           /\ diverted' = [diverted EXCEPT ![o] = m, ![p] = n]
    /\ UNCHANGED calling
