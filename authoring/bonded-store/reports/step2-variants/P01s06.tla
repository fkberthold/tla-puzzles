...
(*                                                                          *)
(* the same wrong subscript, over S06's back-out step                      *)
(* Targets: the wrong-subscript escape                                     *)
(*                                                                          *)
...
MovementIsLawful ==
    [][\A l \in Lots :
          ...
          /\ ((Observe.place[l] = "inStore"
                   /\ Observe'.place[l] # "inStore")
                 => Observe'.place[l] \in {"released", "movedOn"})]_(Observe.dutyPaid)
...
Next == \E l \in Lots:
          ...
          \/ /\ place[l] = "inStore"
             ...
             /\ UNCHANGED dutyPaid
          \/ /\ place[l] = "inStore"
             /\ place' = [place EXCEPT ![l] = "notEntered"]
             /\ UNCHANGED dutyPaid
