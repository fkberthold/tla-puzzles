# Load vector: herbarium-sheet

Rung 6 of batch 2, bead `tla-h2cg.12`. Levels counted 2026-09-05 per V2-PLAN.md section 2.5, off the statement, the frozen reference and the step 2 report together.

| dimension | level | citation |
|---|---|---|
| representation | 2 | `authoring/herbarium-sheet/statement/PROBLEM.md:23,131,147-156; authoring/herbarium-sheet/reference/Herbarium.tla:9` |
