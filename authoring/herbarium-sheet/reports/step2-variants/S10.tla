...
\* Variant S10 (accepted-is-lowest-slip) of the herbarium-sheet reference.
...
BottomName(S) == (CHOOSE r \in S : \A q \in S : r.stamp =< q.stamp).name
...
File(b, s, n) ==
    ...
    /\ LET filed == slips[s] \cup {[name |-> n, stamp |-> reading[b][s]]}
       IN  /\ slips' = [slips EXCEPT ![s] = filed]
           /\ accepted' = [accepted EXCEPT ![s] = BottomName(filed)]
